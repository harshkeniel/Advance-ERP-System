                ...
                <div className="container">
                    <div className="row mt-5">
                        <div className="col-md-3">
                            <form form-inline noValidate onSubmit={formHandler} style={{width: "100%"}}>
                                ...
                                {!isLoading && <button type="submit" className="btn btn-primary btn-block">Search</button>}
                            </form>

                        </div>
                        <div className="col-md-9">
                            
                            {store.admin.allFaculty.length !== 0 && <table className="table border crossword">
                                <thead>
                                    <tr>
