        ...
        <div className="container-fluid">
            <div className="row" id="trail">
                <div className="col-md-12" style={{display: "flex", height: "100vh"}}>
                    <div className="col-md-4 m-auto border" style={{ backgroundColor: "white", borderRadius: "1.2rem", padding: "1rem 1rem 0rem 1rem" }}>
                                <div>
                                    <h4 className="text-center ">Faculty Login</h4>
                                    <form noValidate onSubmit={facultyFormHandler} style={{width: "90%"}}>
                                        ...
                                        {!isFacultyLoading && <button type="submit" className="btn btn-success btn-block">Login</button>}
                                    </form>
                    ...
                    <div className="col-md-4 m-auto border" style={{ backgroundColor: "white", borderRadius: "1.2rem", padding: "1rem 1rem 0rem 1rem" }}>
                        <div>
                            ...
                            <form noValidate onSubmit={studentFormHandler} style={{width: "90%"}}>
                                <div className="form-group">
                                ...
                                {!isStudentLoading && <button type="submit" className="btn btn-success btn-block ">Login</button>}
